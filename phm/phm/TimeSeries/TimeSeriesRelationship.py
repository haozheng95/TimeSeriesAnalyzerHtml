...
from phm.phm.TimeSeries.Utils import check_numeric_array, compute_corr
...
class TimeSeriesRelationship:
    ...
    def feature_rel_to_string(self):
        return self.features_corr_matrix.to_json()
