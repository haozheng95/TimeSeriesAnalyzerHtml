...
from phm.phm.TimeSeries.TimeSeriesAnalyzer import TimeSeriesAnalyzer

__mtime__ = '2019-10-31'


def phm_17():
    data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data/training17.data")
    ...
    return dict(
        ...
        feature_desc={x: t.get_feature_desc(x) for x in feature_list},
...
def phm_16():
    data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data/training16.data")
